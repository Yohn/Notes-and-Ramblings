---
modified: 2024-09-06T05:44:40-04:00
tags:
  - laravel
  - laravel11
  - docs
...
- [Unsupported Environments and Fallbacks](<#Unsupported Environments and Fallbacks>)
...
Laravel Prompts is perfect for accepting user input in your [Artisan console commands](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/01.artisan#writing-commands), but it may also be used in any command-line PHP project.

> [!NOTE]
> Laravel Prompts supports macOS, Linux, and Windows with WSL. For more information, please see our documentation on [unsupported environments & fallbacks](<#unsupported environments & fallbacks>).
...
Alternatively, you may leverage the power of Laravel's [validator](/12.Laravel%2011.x%20Docs/04.The%20Basics/12.validation). To do so, provide an array containing the name of the attribute and the desired validation rules to the `validate` argument:
