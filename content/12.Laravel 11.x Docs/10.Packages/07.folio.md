---
modified: 2024-09-07T01:33:29-04:00
tags:
  - laravel
  - laravel11
  - docs
...
When using Folio, you should always take advantage of [Laravel's route caching capabilities](</12.Laravel%2011.x%20Docs/04.The%20Basics/01.routing#route caching>). Folio listens for the `route:cache` Artisan command to ensure that Folio page definitions and route names are properly cached for maximum performance.
