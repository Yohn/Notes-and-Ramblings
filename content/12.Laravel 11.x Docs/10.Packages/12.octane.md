---
modified: 2024-09-06T05:45:56-04:00
tags:
  - laravel
  - laravel11
  - docs
...
If you plan to develop your application using [Laravel Sail](/12.Laravel%2011.x%20Docs/10.Packages/20.sail), you should run the following commands to install Octane and FrankenPHP:
...
If you plan to develop your application using [Laravel Sail](/12.Laravel%2011.x%20Docs/10.Packages/20.sail), you should run the following commands to install Octane and RoadRunner:
...
Alternatively, you may develop your Swoole based Octane application using [Laravel Sail](/12.Laravel%2011.x%20Docs/10.Packages/20.sail), the official Docker based development environment for Laravel. Laravel Sail includes the Swoole extension by default. However, you will still need to adjust the `docker-compose.yml` file used by Sail.
...
If you are using the Swoole application server, you may also specify how many ["task workers"](<#"task workers">) you wish to start:
