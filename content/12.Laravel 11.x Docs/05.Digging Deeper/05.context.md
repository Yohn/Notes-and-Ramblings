---
modified: 2024-10-05T17:44:08-04:00
tags:
  - laravel
  - laravel11
  - docs
...
The best way to understand Laravel's context capabilities is to see it in action using the built-in logging features. To get started, you may [add information to the context](<#add information to the context>) using the `Context` facade. In this example, we will use a [middleware](/12.Laravel%2011.x%20Docs/04.The%20Basics/02.middleware) to add the request URL and a unique trace ID to the context on every incoming request:
