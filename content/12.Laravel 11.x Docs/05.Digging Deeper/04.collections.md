---
modified: 2024-09-14T06:25:46-04:00
tags:
  - laravel
  - laravel11
  - docs
...
> [!NOTE]
> The results of [Eloquent](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/01.eloquent) queries are always returned as `Collection` instances.
...
Typically, you should declare collection macros in the `boot` method of a [service provider](/12.Laravel%2011.x%20Docs/03.Architecture%20Concepts/03.providers).
...
| ------------------------------------------- | ----------------------------------------- | ------------------------------------------- | ------------------------------------------- |
| [after](<#`after()`>)                       | [flip](<#`flip()`>)                       | [pipeInto](<#`pipeInto()`>)                 | [take](<#`take()`>)                         |
| [all](<#`all()`>)                           | [forget](<#`forget()`>)                   | [pipeThrough](<#`pipeThrough()`>)           | [takeUntil](<#`takeUntil()`>)               |
| [average](<#`average()`>)                   | [forPage](<#`forPage()`>)                 | [pluck](<#`pluck()`>)                       | [takeWhile](<#`takeWhile()`>)               |
| [avg](<#`avg()`>)                           | [get](<#`get()`>)                         | [pop](<#`pop()`>)                           | [tap](<#`tap()`>)                           |
| [before](<#`before()`>)                     | [groupBy](<#`groupBy()`>)                 | [prepend](<#`prepend()`>)                   | [times](<#`times()`>)                       |
| [chunk](<#`chunk()`>)                       | [has](<#`has()`>)                         | [pull](<#`pull()`>)                         | [toArray](<#`toArray()`>)                   |
| [chunkWhile](<#`chunkWhile()`>)             | [hasAny](<#`hasAny()`>)                   | [push](<#`push()`>)                         | [toJson](<#`toJson()`>)                     |
| [collapse](<#`collapse()`>)                 | [implode](<#`implode()`>)                 | [put](<#`put()`>)                           | [transform](<#`transform()`>)               |
| [collect](<#`collect()`>)                   | [intersect](<#`intersect()`>)             | [random](<#`random()`>)                     | [undot](<#`undot()`>)                       |
| [combine](<#`combine()`>)                   | [intersectAssoc](<#`intersectAssoc()`>)   | [range](<#`range()`>)                       | [union](<#`union()`>)                       |
| [concat](<#`concat()`>)                     | [intersectByKeys](<#`intersectByKeys()`>) | [reduce](<#`reduce()`>)                     | [unique](<#`unique()`>)                     |
| [contains](<#`contains()`>)                 | [isEmpty](<#`isEmpty()`>)                 | [reduceSpread](<#`reduceSpread()`>)         | [uniqueStrict](<#`uniqueStrict()`>)         |
| [containsOneItem](<#`containsOneItem()`>)   | [isNotEmpty](<#`isNotEmpty()`>)           | [reject](<#`reject()`>)                     | [unless](<#`unless()`>)                     |
| [containsStrict](<#`containsStrict()`>)     | [join](<#`join()`>)                       | [replace](<#`replace()`>)                   | [unlessEmpty](<#`unlessEmpty()`>)           |
| [count](<#`count()`>)                       | [keyBy](<#`keyBy()`>)                     | [replaceRecursive](<#`replaceRecursive()`>) | [unlessNotEmpty](<#`unlessNotEmpty()`>)     |
| [countBy](<#`countBy()`>)                   | [keys](<#`keys()`>)                       | [reverse](<#`reverse()`>)                   | [unwrap](<#`unwrap()`>)                     |
| [crossJoin](<#`crossJoin()`>)               | [last](<#`last()`>)                       | [search](<#`search()`>)                     | [value](<#`value()`>)                       |
| [dd](<#`dd()`>)                             | [lazy](<#`lazy()`>)                       | [select](<#`select()`>)                     | [values](<#`values()`>)                     |
| [diff](<#`diff()`>)                         | [macro](<#`macro()`>)                     | [shift](<#`shift()`>)                       | [when](<#`when()`>)                         |
| [diffAssoc](<#`diffAssoc()`>)               | [make](<#`make()`>)                       | [shuffle](<#`shuffle()`>)                   | [whenEmpty](<#`whenEmpty()`>)               |
| [diffAssocUsing](<#`diffAssocUsing()`>)     | [map](<#`map()`>)                         | [skip](<#`skip()`>)                         | [whenNotEmpty](<#`whenNotEmpty()`>)         |
| [diffKeys](<#`diffKeys()`>)                 | [mapInto](<#`mapInto()`>)                 | [skipUntil](<#`skipUntil()`>)               | [where](<#`where()`>)                       |
| [doesntContain](<#`doesntContain()`>)       | [mapSpread](<#`mapSpread()`>)             | [skipWhile](<#`skipWhile()`>)               | [whereStrict](<#`whereStrict()`>)           |
| [dot](<#`dot()`>)                           | [mapToGroups](<#`mapToGroups()`>)         | [slice](<#`slice()`>)                       | [whereBetween](<#`whereBetween()`>)         |
| [dump](<#`dump()`>)                         | [mapWithKeys](<#`mapWithKeys()`>)         | [sliding](<#`sliding()`>)                   | [whereIn](<#`whereIn()`>)                   |
| [duplicates](<#`duplicates()`>)             | [max](<#`max()`>)                         | [sole](<#`sole()`>)                         | [whereInStrict](<#`whereInStrict()`>)       |
| [duplicatesStrict](<#`duplicatesStrict()`>) | [median](<#`median()`>)                   | [some](<#`some()`>)                         | [whereInstanceOf](<#`whereInstanceOf()`>)   |
| [each](<#`each()`>)                         | [merge](<#`merge()`>)                     | [sort](<#`sort()`>)                         | [whereNotBetween](<#`whereNotBetween()`>)   |
| [eachSpread](<#`eachSpread()`>)             | [mergeRecursive](<#`mergeRecursive()`>)   | [sortBy](<#`sortBy()`>)                     | [whereNotIn](<#`whereNotIn()`>)             |
| [ensure](<#`ensure()`>)                     | [min](<#`min()`>)                         | [sortByDesc](<#`sortByDesc()`>)             | [whereNotInStrict](<#`whereNotInStrict()`>) |
| [every](<#`every()`>)                       | [mode](<#`mode()`>)                       | [sortDesc](<#`sortDesc()`>)                 | [whereNotNull](<#`whereNotNull()`>)         |
| [except](<#`except()`>)                     | [multiply](<#`multiply()`>)               | [sortKeys](<#`sortKeys()`>)                 | [whereNull](<#`whereNull()`>)               |
| [filter](<#`filter()`>)                     | [nth](<#`nth()`>)                         | [sortKeysDesc](<#`sortKeysDesc()`>)         | [wrap](<#`wrap()`>)                         |
| [first](<#`first()`>)                       | [only](<#`only()`>)                       | [sortKeysUsing](<#`sortKeysUsing()`>)       | [zip](<#`zip()`>)                           |
| [firstOrFail](<#`firstOrFail()`>)           | [pad](<#`pad()`>)                         | [splice](<#`splice()`>)                     |                                             |
| [firstWhere](<#`firstWhere()`>)             | [partition](<#`partition()`>)             | [split](<#`split()`>)                       |                                             |
| [flatMap](<#`flatMap()`>)                   | [percentage](<#`percentage()`>)           | [splitIn](<#`splitIn()`>)                   |                                             |
| [flatten](<#`flatten()`>)                   | [pipe](<#`pipe()`>)                       | [sum](<#`sum()`>)                           |                                             |
...
This method is especially useful in [views](/12.Laravel%2011.x%20Docs/04.The%20Basics/07.views) when working with a grid system such as [Bootstrap](https://getbootstrap.com/docs/5.3/layout/grid/). For example, imagine you have a collection of [Eloquent](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/01.eloquent) models you want to display in a grid:
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-contains).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-diff).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-except).
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-intersect).
...
The `lazy` method returns a new [`LazyCollection`](#`LazyCollection`) instance from the underlying array of items:
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-only).
...
The `toArray` method converts the collection into a plain PHP `array`. If the collection's values are [Eloquent](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/01.eloquent) models, the models will also be converted to arrays:
...
> [!WARNING] > `toArray` also converts all of the collection's nested objects that are an instance of `Arrayable` to an array. If you want to get the raw array underlying the collection, use the [`all`](#`all`) method instead.
...
> [!NOTE]
> This method's behavior is modified when using [Eloquent Collections](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/03.eloquent-collections#method-unique).
...
| func                                  | func                                | func                                  | func                                  |
| ------------------------------------- | ----------------------------------- | ------------------------------------- | ------------------------------------- |
| [all](#all)                           | [firstWhere](#firstWhere)           | [mergeRecursive](#mergeRecursive)     | [take](#take)                         |
| [average](#average)                   | [flatMap](#flatMap)                 | [min](#min)                           | [tap](#tap)                           |
| [avg](#avg)                           | [flatten](#flatten)                 | [mode](#mode)                         | [times](#times)                       |
| [chunk](#chunk)                       | [flip](#flip)                       | [nth](#nth)                           | [toArray](#toArray)                   |
| [chunkWhile](#chunkWhile)             | [forPage](#forPage)                 | [only](#only)                         | [toJson](#toJson)                     |
| [collapse](#collapse)                 | [get](#get)                         | [pad](#pad)                           | [union](#union)                       |
| [collect](#collect)                   | [groupBy](#groupBy)                 | [partition](#partition)               | [unique](#unique)                     |
| [combine](#combine)                   | [has](#has)                         | [pipe](#pipe)                         | [uniqueStrict](#uniqueStrict)         |
| [concat](#concat)                     | [implode](#implode)                 | [pluck](#pluck)                       | [unless](#unless)                     |
| [contains](#contains)                 | [intersect](#intersect)             | [random](#random)                     | [unlessEmpty](#unlessEmpty)           |
| [containsStrict](#containsStrict)     | [intersectAssoc](#intersectAssoc)   | [reduce](#reduce)                     | [unlessNotEmpty](#unlessNotEmpty)     |
| [count](#count)                       | [intersectByKeys](#intersectByKeys) | [reject](#reject)                     | [unwrap](#unwrap)                     |
| [countBy](#countBy)                   | [isEmpty](#isEmpty)                 | [replace](#replace)                   | [values](#values)                     |
| [crossJoin](#crossJoin)               | [isNotEmpty](#isNotEmpty)           | [replaceRecursive](#replaceRecursive) | [when](#when)                         |
| [dd](#dd)                             | [join](#join)                       | [reverse](#reverse)                   | [whenEmpty](#whenEmpty)               |
| [diff](#diff)                         | [keyBy](#keyBy)                     | [search](#search)                     | [whenNotEmpty](#whenNotEmpty)         |
| [diffAssoc](#diffAssoc)               | [keys](#keys)                       | [shuffle](#shuffle)                   | [where](#where)                       |
| [diffKeys](#diffKeys)                 | [last](#last)                       | [skip](#skip)                         | [whereStrict](#whereStrict)           |
| [dump](#dump)                         | [macro](#macro)                     | [slice](#slice)                       | [whereBetween](#whereBetween)         |
| [duplicates](#duplicates)             | [make](#make)                       | [sole](#sole)                         | [whereIn](#whereIn)                   |
| [duplicatesStrict](#duplicatesStrict) | [map](#map)                         | [some](#some)                         | [whereInStrict](#whereInStrict)       |
| [each](#each)                         | [mapInto](#mapInto)                 | [sort](#sort)                         | [whereInstanceOf](#whereInstanceOf)   |
| [eachSpread](#eachSpread)             | [mapSpread](#mapSpread)             | [sortBy](#sortBy)                     | [whereNotBetween](#whereNotBetween)   |
| [every](#every)                       | [mapToGroups](#mapToGroups)         | [sortByDesc](#sortByDesc)             | [whereNotIn](#whereNotIn)             |
| [except](#except)                     | [mapWithKeys](#mapWithKeys)         | [sortKeys](#sortKeys)                 | [whereNotInStrict](#whereNotInStrict) |
| [filter](#filter)                     | [max](#max)                         | [sortKeysDesc](#sortKeysDesc)         | [wrap](#wrap)                         |
| [first](#first)                       | [median](#median)                   | [split](#split)                       | [zip](#zip)                           |
| [firstOrFail](#firstOrFail)           | [merge](#merge)                     | [sum](#sum)                           |                                       |
...
To illustrate the usage of this method, imagine an application that submits invoices from the database using a cursor. You could define a [scheduled task](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/19.scheduling) that runs every 15 minutes and only processes invoices for a maximum of 14 minutes:
