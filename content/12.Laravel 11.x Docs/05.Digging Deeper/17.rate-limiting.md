---
modified: 2024-10-05T17:44:36-04:00
tags:
  - laravel
  - laravel11
  - docs
...
Laravel includes a simple to use rate limiting abstraction which, in conjunction with your application's [03.cache](05.Digging%20Deeper/03.cache.md), provides an easy way to limit any action during a specified window of time.

> [!NOTE]
> If you are interested in rate limiting incoming HTTP requests, please consult the [rate limiter middleware documentation](/12.Laravel%2011.x%20Docs/04.The%20Basics/01.routing#rate-limiting).
