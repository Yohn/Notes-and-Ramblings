---
modified: 2024-10-31T01:45:37-04:00
tags:
  - laravel
  - laravel11
  - docs
...
| Strings                                         | Function                                          | List                                              |
| ----------------------------------------------- | ------------------------------------------------- | ------------------------------------------------- |
| [\_\_](<#`__()`>) (language)                    | [class_basename](<#`class_basename()`>)           | [e](<#`e()`>)                                     |
| [preg_replace_array](<#`preg_replace_array()`>) | [Str::after](<#`Str  after()`>)                   | [Str::afterLast](<#`Str  afterLast()`>)           |
| [Str::apa](<#`Str  apa()`>)                     | [Str::ascii](<#`Str  ascii()`>)                   | [Str::before](<#`Str  before()`>)                 |
| [Str::beforeLast](<#`Str  beforeLast()`>)       | [Str::between](<#`Str  between()`>)               | [Str::betweenFirst](<#`Str  betweenFirst()`>)     |
| [Str::camel](<#`Str  camel()`>)                 | [Str::charAt](<#`Str  charAt()`>)                 | [Str::chopStart](<#`Str  chopStart()`>)           |
| [Str::chopEnd](<#`Str  chopEnd()`>)             | [Str::contains](<#`Str  contains()`>)             | [Str::containsAll](<#`Str  containsAll()`>)       |
| [Str::endsWith](<#`Str  endsWith()`>)           | [Str::excerpt](<#`Str  excerpt()`>)               | [Str::finish](<#`Str  finish()`>)                 |
| [Str::headline](<#`Str  headline()`>)           | [Str::inlineMarkdown](<#`Str  inlineMarkdown()`>) | [Markdown Security](<#Markdown Security 1>)       |
| [Str::is](<#`Str  is()`>)                       | [Str::isAscii](<#`Str  isAscii()`>)               | [Str::isJson](<#`Str  isJson()`>)                 |
| [Str::isUrl](<#`Str  isUrl()`>)                 | [Str::isUlid](<#`Str  isUlid()`>)                 | [Str::isUuid](<#`Str  isUuid()`>)                 |
| [Str::kebab](<#`Str  kebab()`>)                 | [Str::lcfirst](<#`Str  lcfirst()`>)               | [Str::length](<#`Str  length()`>)                 |
| [Str::limit](<#`Str  limit()`>)                 | [Str::lower](<#`Str  lower()`>)                   | [Str::markdown](<#`Str  markdown()`>)             |
| [Markdown Security](<#Markdown Security 2>)     | [Str::mask](<#`Str  mask()`>)                     | [Str::orderedUuid](<#`Str  orderedUuid()`>)       |
| [Str::padBoth](<#`Str  padBoth()`>)             | [Str::padLeft](<#`Str  padLeft()`>)               | [Str::padRight](<#`Str  padRight()`>)             |
| [Str::password](<#`Str  password()`>)           | [Str::plural](<#`Str  plural()`>)                 | [Str::pluralStudly](<#`Str  pluralStudly()`>)     |
| [Str::position](<#`Str  position()`>)           | [Str::random](<#`Str  random()`>)                 | [Str::remove](<#`Str  remove()`>)                 |
| [Str::repeat](<#`Str  repeat()`>)               | [Str::replace](<#`Str  replace()`>)               | [Str::replaceArray](<#`Str  replaceArray()`>)     |
| [Str::replaceFirst](<#`Str  replaceFirst()`>)   | [Str::replaceLast](<#`Str  replaceLast()`>)       | [Str::replaceMatches](<#`Str  replaceMatches()`>) |
| [Str::replaceStart](<#`Str  replaceStart()`>)   | [Str::replaceEnd](<#`Str  replaceEnd()`>)         | [Str::reverse](<#`Str  reverse()`>)               |
| [Str::singular](<#`Str  singular()`>)           | [Str::slug](<#`Str  slug()`>)                     | [Str::snake](<#`Str  snake()`>)                   |
| [Str::squish](<#`Str  squish()`>)               | [Str::start](<#`Str  start()`>)                   | [Str::startsWith](<#`Str  startsWith()`>)         |
| [Str::studly](<#`Str  studly()`>)               | [Str::substr](<#`Str  substr()`>)                 | [Str::substrCount](<#`Str  substrCount()`>)       |
| [Str::substrReplace](<#`Str  substrReplace()`>) | [Str::swap](<#`Str  swap()`>)                     | [Str::take](<#`Str  take()`>)                     |
| [Str::title](<#`Str  title()`>)                 | [Str::toBase64](<#`Str  toBase64()`>)             | [Str::toHtmlString](<#`Str  toHtmlString()`>)     |
| [Str::transliterate](<#`Str  transliterate()`>) | [Str::trim](<#`Str  trim()`>)                     | [Str::ltrim](<#`Str  ltrim()`>)                   |
| [Str::rtrim](<#`Str  rtrim()`>)                 | [Str::ucfirst](<#`Str  ucfirst()`>)               | [Str::ucsplit](<#`Str  ucsplit()`>)               |
| [Str::upper](<#`Str  upper()`>)                 | [Str::ulid](<#`Str  ulid()`>)                     | [Str::unwrap](<#`Str  unwrap()`>)                 |
| [Str::uuid](<#`Str  uuid()`>)                   | [Str::wordCount](<#`Str  wordCount()`>)           | [Str::wordWrap](<#`Str  wordWrap()`>)             |
| [Str::words](<#`Str  words()`>)                 | [Str::wrap](<#`Str  wrap()`>)                     | [str](<#`str()`>)                                 |
| [trans](<#`trans()`>)                           | [trans_choice](<#`trans_choice()`>)               |                                                   |
...
| Fluent                                | Strings                                     | List                                |
| ------------------------------------- | ------------------------------------------- | ----------------------------------- |
| [after](#`after`)                     | [afterLast](#`afterLast`)                   | [apa](#`apa`)                       |
| [append](#`append`)                   | [ascii](#`ascii`)                           | [basename](#`basename`)             |
| [before](#`before`)                   | [beforeLast](#`beforeLast`)                 | [between](#`between`)               |
| [betweenFirst](#`betweenFirst`)       | [camel](#`camel`)                           | [charAt](#`charAt`)                 |
| [classBasename](#`classBasename`)     | [chopStart](#`chopStart`)                   | [chopEnd](#`chopEnd`)               |
| [contains](#`contains`)               | [containsAll](#`containsAll`)               | [dirname](#`dirname`)               |
| [excerpt](#`excerpt`)                 | [endsWith](#`endsWith`)                     | [exactly](#`exactly`)               |
| [explode](#`explode`)                 | [finish](#`finish`)                         | [headline](#`headline`)             |
| [inlineMarkdown](#`inlineMarkdown`)   | [Markdown Security](<#Markdown Security 3>) | [is](#`is`)                         |
| [isAscii](#`isAscii`)                 | [isEmpty](#`isEmpty`)                       | [isNotEmpty](#`isNotEmpty`)         |
| [isJson](#`isJson`)                   | [isUlid](#`isUlid`)                         | [isUrl](#`isUrl`)                   |
| [isUuid](#`isUuid`)                   | [kebab](#`kebab`)                           | [lcfirst](#`lcfirst`)               |
| [length](#`length`)                   | [limit](#`limit`)                           | [lower](#`lower`)                   |
| [markdown](#`markdown`)               | [Markdown Security](<#Markdown Security 4>) | [mask](#`mask`)                     |
| [match](#`match`)                     | [matchAll](#`matchAll`)                     | [isMatch](#`isMatch`)               |
| [newLine](#`newLine`)                 | [padBoth](#`padBoth`)                       | [padLeft](#`padLeft`)               |
| [padRight](#`padRight`)               | [pipe](#`pipe`)                             | [plural](#`plural`)                 |
| [position](#`position`)               | [prepend](#`prepend`)                       | [remove](#`remove`)                 |
| [repeat](#`repeat`)                   | [replace](#`replace`)                       | [replaceArray](#`replaceArray`)     |
| [replaceFirst](#`replaceFirst`)       | [replaceLast](#`replaceLast`)               | [replaceMatches](#`replaceMatches`) |
| [replaceStart](#`replaceStart`)       | [replaceEnd](#`replaceEnd`)                 | [scan](#`scan`)                     |
| [singular](#`singular`)               | [slug](#`slug`)                             | [snake](#`snake`)                   |
| [split](#`split`)                     | [squish](#`squish`)                         | [start](#`start`)                   |
| [startsWith](#`startsWith`)           | [stripTags](#`stripTags`)                   | [studly](#`studly`)                 |
| [substr](#`substr`)                   | [substrReplace](#`substrReplace`)           | [swap](#`swap`)                     |
| [take](#`take`)                       | [tap](#`tap`)                               | [test](#`test`)                     |
| [title](#`title`)                     | [toBase64](<#`toBase64()`>)                 | [transliterate](#`transliterate`)   |
| [trim](#`trim`)                       | [ltrim](#`ltrim`)                           | [rtrim](#`rtrim`)                   |
| [ucfirst](#`ucfirst`)                 | [ucsplit](#`ucsplit`)                       | [unwrap](#`unwrap`)                 |
| [upper](#`upper`)                     | [when](#`when`)                             | [whenContains](#`whenContains`)     |
| [whenContainsAll](#`whenContainsAll`) | [whenEmpty](#`whenEmpty`)                   | [whenNotEmpty](#`whenNotEmpty`)     |
| [whenStartsWith](#`whenStartsWith`)   | [whenEndsWith](#`whenEndsWith`)             | [whenExactly](#`whenExactly`)       |
| [whenNotExactly](#`whenNotExactly`)   | [whenIs](#`whenIs`)                         | [whenIsAscii](#`whenIsAscii`)       |
| [whenIsUlid](#`whenIsUlid`)           | [whenIsUuid](#`whenIsUuid`)                 | [whenTest](#`whenTest`)             |
| [wordCount](#`wordCount`)             | [words](#`words`)                           |                                     |
...
The `__` function translates the given translation string or translation key using your [language files](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization):
...
The `Str::plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Laravel's pluralizer](</12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization#Pluralization Language>):
...
The `Str::pluralStudly` method converts a singular word string formatted in studly caps case to its plural form. This function supports [any of the languages support by Laravel's pluralizer](</12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization#Pluralization Language>):
...
The `Str::singular` method converts a string to its singular form. This function supports [any of the languages support by Laravel's pluralizer](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization#pluralization-language):
...
The `trans` function translates the given translation key using your [language files](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization):
...
The `plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Laravel's pluralizer](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization#pluralization-language):
...
The `singular` method converts a string to its singular form. This function supports [any of the languages support by Laravel's pluralizer](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/11.localization#pluralization-language):
