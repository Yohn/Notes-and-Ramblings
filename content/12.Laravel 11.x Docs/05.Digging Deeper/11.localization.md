---
modified: 2024-10-05T17:50:36-04:00
tags:
  - laravel
  - laravel11
  - docs
...
> [!WARNING]
> If you customize the pluralizer's language, you should explicitly define your Eloquent model's [table names](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/01.eloquent#table-names).
...
If you are using your [default translation strings as your translation keys](<#default translation strings as your translation keys>), you should pass the default translation of your string to the `__` function;
...
If you are using the [Blade templating engine](/12.Laravel%2011.x%20Docs/04.The%20Basics/08.blade), you may use the `{{ }}` echo syntax to display the translation string:
...
Of course, pluralization is also supported when using [translation strings as keys](<#translation strings as keys>):
