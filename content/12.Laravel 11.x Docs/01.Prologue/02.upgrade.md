...
- [Upgrading To 11.0 From 10.x](<#Upgrading To 11.0 From 10.x>)
...
- [The `UserProvider` Contract](<#The `UserProvider` Contract>)
...
- [Laravel Spark Stripe](<#Laravel Spark Stripe>)
...
If you do not want to update all of the existing "change" migrations in your application to retain the column's existing attributes, you may simply [squash your migrations](/12.Laravel%2011.x%20Docs/07.Database/04.migrations#squashing-migrations):
