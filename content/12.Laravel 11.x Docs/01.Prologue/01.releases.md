---
modified: 2024-09-14T03:33:22-04:00
tags:
  - laravel
  - laravel11
  - docs
...
For all Laravel releases, bug fixes are provided for 18 months and security fixes are provided for 2 years. For all additional libraries, including Lumen, only the latest major release receives bug fixes. In addition, please review the database versions [supported by Laravel](/12.Laravel%2011.x%20Docs/07.Database/01.database#introduction).
...
For more information on Laravel Reverb, please consult the complete [Reverb documentation](/12.Laravel%2011.x%20Docs/10.Packages/19.reverb).
...
For more information on rate limiting in Laravel, check out the [rate limiting documentation](/12.Laravel%2011.x%20Docs/04.The%20Basics/01.routing#rate-limiting).
...
For more information on encryption in Laravel, check out the [encryption documentation](/12.Laravel%2011.x%20Docs/06.Security/04.).
...
[Laravel Prompts](/12.Laravel%2011.x%20Docs/10.Packages/17.prompts) is a PHP package for adding beautiful and user-friendly forms to your command-line applications, with browser-like features including placeholder text and validation.
...
However, this can become cumbersome when dealing with many inputs or complicated validation scenarios. Therefore, in Laravel 11, you may utilize the full power of Laravel's [validator](/12.Laravel%2011.x%20Docs/04.The%20Basics/12.validation) when validating prompt inputs:
...
For more information on testing queued jobs, check out the [queue documentation](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/16.queues#testing).
...
For more information on attribute casting, review the [Eloquent documentation](/12.Laravel%2011.x%20Docs/08.Eloquent%20ORM/04.eloquent-mutators#attribute-casting).
...
For more information on the `once` helper, check out the [helpers documentation](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/09.helpers#method-once).
...
For more information on Laravel's database drivers, check out the [database documentation](/12.Laravel%2011.x%20Docs/07.Database/01.database).
