---
modified: 2024-09-06T05:19:07-04:00
tags:
  - laravel
  - laravel11
  - docs
...
- [Introduction](#Introduction)
  - [Writing Views in React / Vue](<#Writing Views in React / Vue>)
...
> [!NOTE]
> Looking for more information on how to write Blade templates? Check out the full [Blade documentation](/12.Laravel%2011.x%20Docs/04.The%20Basics/08.blade) to get started.
...
The `.blade.php` extension informs the framework that the file contains a [Blade template](/12.Laravel%2011.x%20Docs/04.The%20Basics/08.blade). Blade templates contain HTML as well as Blade directives that allow you to easily echo values, create "if" statements, iterate over data, and more.
...
As you can see, the first argument passed to the `view` helper corresponds to the name of the view file in the `resources/views` directory. The second argument is an array of data that should be made available to the view. In this case, we are passing the `name` variable, which is displayed in the view using [Blade syntax](/12.Laravel%2011.x%20Docs/04.The%20Basics/08.blade).
...
Typically, view composers will be registered within one of your application's [service providers](/12.Laravel%2011.x%20Docs/03.Architecture%20Concepts/03.providers). In this example, we'll assume that the `App\Providers\AppServiceProvider` will house this logic.
...
As you can see, all view composers are resolved via the [service container](/12.Laravel%2011.x%20Docs/03.Architecture%20Concepts/02.container), so you may type-hint any dependencies you need within a composer's constructor.
