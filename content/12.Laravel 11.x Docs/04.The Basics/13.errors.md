---
modified: 2024-09-06T05:21:27-04:00
tags:
  - laravel
  - laravel11
  - docs
...
In Laravel, exception reporting is used to log exceptions or send them to an external service [Sentry](https://github.com/getsentry/sentry-laravel) or [Flare](https://flareapp.io). By default, exceptions will be logged based on your [logging](/12.Laravel%2011.x%20Docs/04.The%20Basics/14.logging) configuration. However, you are free to log exceptions however you wish.
...
> [!NOTE]
> To customize the exception reporting for a given exception, you may also utilize [reportable exceptions](/12.Laravel%2011.x%20Docs/04.The%20Basics/13.errors#renderable-exceptions).
...
When messages are written to your application's [logs](/12.Laravel%2011.x%20Docs/04.The%20Basics/14.logging), the messages are written at a specified [log level](/12.Laravel%2011.x%20Docs/04.The%20Basics/14.logging#log-levels), which indicates the severity or importance of the message being logged.
...
> [!NOTE]
> You may type-hint any required dependencies of the `report` method and they will automatically be injected into the method by Laravel's [service container](/12.Laravel%2011.x%20Docs/03.Architecture%20Concepts/02.container).
