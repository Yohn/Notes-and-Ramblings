...
Using the `collect` method, you may retrieve all of the incoming request's input data as a [collection](/12.Laravel%2011.x%20Docs/05.Digging%20Deeper/04.collections):
